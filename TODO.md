...
D28 / D29 / D30 测试体系与 PoC 目录（登记日 2026-09-03；依据 `PRD.md`）。**2026-09-03 已达成**：R006 六层测试规范落盘；tests\ab\ A/B 层建成并首跑 tiny vs small（报告 tests\ab\reports\2026-09-03-tiny-vs-small.md）；`READER_OCR_MODEL_SIZE` 档位开关进 src\ocr.rs；poc\ 目录约定落地（G002 八节）加 S006 PoC 迁移。下一目标待用户点名（候选见 `PRD.md` D23 至 D26）。
...
| R006 六层规范 | 已完成 | 六层定义、落点、口径、时机；真样本基线登记 | 2026-09-03 |
