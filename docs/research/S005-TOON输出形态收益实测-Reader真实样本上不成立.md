...
| 样本 | 字节 json→toon | 省% | cl100k | 省% | o200k | 省% | 往返 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| search_zh（1637B） | →1841 | **-12.5** | 520→630 | **-21.2** | 423→532 | **-25.8** | 无损 |
| extract_zh（17690B） | →17383 | +1.7 | 6993→6931 | +0.9 | 5027→4951 | +1.5 | 无损 |
| search_en（13123B） | →13466 | -2.6 | 5518→5688 | -3.1 | 4467→4607 | -3.1 | **破损** |
