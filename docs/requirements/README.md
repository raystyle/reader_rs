...
| REQ-060 | implemented | must | ledger账本集成issue与artifact命令族 | Ed25519 五头签名道；issue new/list/show/close；artifact publish/attest/promote/list；替代 issues.ohmygh.com 旧面 |
