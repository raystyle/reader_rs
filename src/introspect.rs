...
figures 行式: figure: kind | 锚 | 图题或- | 落盘路径 | 字节数B
export 摘要行: export: text/pages/figures/manifest <路径>
ocr 子命令行式: ocr_init: / ocr_doctor: / ocr_switch: 前缀、ASCII token 前置（ok / missing / corrupt / download mirror|huggingface|github / verdict）；doctor 退出码 0 双包完整 / 1 有缺损；init / switch 失败 2
