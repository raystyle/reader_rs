...
| 日期 | 进展 |
| --- | --- |
| 2026-08-31 | P0005 立项：PDF 通道整体切 `extract_pages_markdown` 管线（用户裁决），TextUnit 扩展 needs_ocr，extract/search 各给提示路径；两栏阅读序与无文本页检出进测试面 |
...
- 当前目标（进行中）：PDF 提取质量——markdown 管线与 needs_ocr 提示（P0005）。管线切换、提示路径、测试补强、真实样本回归与性能观察。
