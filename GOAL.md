...
- **锚定的目标**：P0016 markdown 支持落地（已达成：.md 进格式面加 `query` 子命令嵌 mq-lang，23 单元加 52 集成全绿、真样本回归过，归档 `docs\proven\P0016-markdown支持与mq结构化提取.md`）；下版候选为阶段 3 余项（MCP 等）、分发面、OCR 质量升级，待用户点名。
...
- 当前目标（已达成）：P0016 markdown 支持落地——见锚点与 `docs\proven\P0016-markdown支持与mq结构化提取.md`。
